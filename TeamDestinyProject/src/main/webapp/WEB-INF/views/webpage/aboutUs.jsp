...
<div class="container" style="font-family:'Noto Sans KR', sans-serif; color: #ebebeb; background-color: rgba( 0, 0, 0, 0.8 );">
      <div class="col-sm-12" id="about">
         <h2 class="w3-border-bottom w3-border-light-grey w3-padding-16">About Destiny</h2>
         <div>
            <img src="http://erotic-chaos.com/wp-content/uploads/2017/08/main_002.png" width=100%>
         </div>
      </div>
