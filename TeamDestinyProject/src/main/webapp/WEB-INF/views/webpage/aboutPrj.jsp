...
<div class="container">
   <div style="font-family:'Noto Sans KR', sans-serif; color: #1e1e1e;">
         <h2 style="font-family:'Noto Sans KR', sans-serif; color: #1e1e1e;">Projects</h2>
   </div>
	...
	<div class="col-lg-12 col-md-12 col-sm-12">
      ...
      <div align="center" style="font-family:'Noto Sans KR', sans-serif; color: #1e1e1e;">
      ...
      <!-- 프로젝트 소개 상세 -->
      <div class="aboutprj" style="font-family:'Noto Sans KR', sans-serif; color: #1e1e1e;">
         
         <div id="phase2_detail">
         <div style="border-bottom: 1px solid #1e1e1e;">
            <h3>사용자 맞춤 분석환경 | 파일관리와 데이터조회</h3>
            </div>
            <table border=0 style="cellpadding:0; width:100%; align:left;">
            <tr>
            <td>
            ...
            <p><b>분석 파일을 csv 형식으로 업로드 해 주세요.</p><p>DB에 저장된 파일의 목록을 언제든지 조회할 수 있습니다.</b></p>
            <div class="blank">&nbsp;</div>          
            <p>데이터 분석 과정에 사용할 수 있도록 테이블 형식으로 변형하여 구조를 보기 쉽게 화면에 출력해 줍니다.</p><p> 
            테이블의 열을 체크하여 변수 각각에 대한 전처리 작업을 빠르게 진행할 수 있습니다. 
            </p><p>분석 단계마다 도출된 결과를 DB에 저장하여 변경 내용을 조회하고,
       ...
       <p>데이터의 각 변수에 대한 기초 통계 정보를 통해이상치와 결측치를 확인할 수 있습니다.</p><p>
       전처리 작업을 진행할 열을 선택하고 함수를 적용하세요.
       해당 열의 값을 그룹별 평균으로, NA 값을 지정한 숫자로 변형시키는 함수 등</p><p>이상치와 결측치를 처리하기 위한 다양한 함수를 제공합니다.</p><p>
       데이터와 함수 선택만으로 전처리를 완료함으로써 복잡한 수식 적용으로 인한 시간과 오류를 대폭 줄일 수 있습니다.</p>
       </div>
       </td>
       ...
       <div class="blank">&nbsp;</div>
         ...
         <div style="border-bottom: 1px solid #1e1e1e;">
            ...
            <table border=0 cellpadding=0 width=100%>
            <tr>
            <td class="column" style="text-align:right; padding-right:10px;">
            테이블 구조를 변형 시키기 위한 기능을 제공합니다.<br>
               split, pivot, unpivot할 열을 선택하고 재구조화 방법을 선택하거나 
               결합하고자 하는 데이터를 불러와 두 개의 테이블을 결합합니다.<br>분석에 용이한 형태로 테이블의 구조를 변형함으로써쉽게 파악하지 못했던 데이터간의 유의미한 관계를 도출할 수 있습니다.
         ...
         <div id="phase5_detail">
            ...
            <div class="col-lg-4 col-md-6 col-sm-4" style="float:left;">
			<img src="http://erotic-chaos.com/wp-content/uploads/2017/08/prj.png" style="width:100%;">
            </div>
            
            <div class="col-lg-8 col-md-6 col-sm-8 column" style="float:left; text-align:left;">
...
분석 결과 뿐만 아니라 업무에 용이하게 사용될 수 있도록 해석에 대한 가이드라인을 지원합니다.
         ...
         <div class="col-lg-12 col-md-12 col-sm-12 blank">&nbsp;</div>
