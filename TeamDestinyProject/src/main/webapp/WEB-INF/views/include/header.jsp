...
<body>
	<!-- onload="document.getElementById('id01').style.display='block'" -->
	<header>
...
required>        		
        		...
        		<div class="form-group">
        			...
        			<div class="col-sm-9">
          				<input class="form-control" id="inputPassword" type="password" name="userPw" placeholder="비밀번호" 
...
required>
				...
				<div class="form-group">
            		...
            		<input class="btn btn-primary" action="action" onclick="return confirm('회원 가입을 완료하시겠습니까?')" type="submit" 
