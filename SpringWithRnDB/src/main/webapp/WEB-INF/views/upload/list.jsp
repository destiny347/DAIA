   ...
   <form action="${actionURL}" method="post" enctype="multipart/form-data"
      ...
      <table border="1">
         ...
         <c:forEach var="file" items="${fileList}">
            <tr>
               <td><input type="checkbox" name="fileId" id="${file.fileId}"
                  value="${file.fileName}">${file.fileId}</td>
      ...
      <h3></h3>
      <input type="button" onclick="checkSelectedValue();checkSelectedId();" value="선택영역 확인"/>
      
         <h3>확인</h3>
         
         <div class="dibugConsole" id="dibugConsole"></div>
         <h3></h3>
         <a href='<c:url value="/analytics/info/"+/>'><input type="button" value="다음"/></a>
